...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('mainapp', '0003_auto_20210321_1842'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'Формируется'), ('STP', 'Отправлен в обработку'), ('PRD', 'Oбрабатывается'), ('PD', 'Oплачен'), ('RDY', 'Готов к выдаче'), ('CNC', 'Oтменен')], default='FM', max_length=3, verbose_name='Статус')),
